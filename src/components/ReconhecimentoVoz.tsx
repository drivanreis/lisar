...
import { tpWindows, tpEventoReconhecimentoVoz } from '../types/tiposReconhecimentoVoz';
...
const ReconhecimentoVoz: React.FC = () => {
  ...
  const startRecognition = () => {
    const ReconhecimentoVozAPI = tpWindows.SpeechRecognition || tpWindows.webkitSpeechRecognition;
    ...
    reconhecimento.onresult = (event: tpEventoReconhecimentoVoz) => {
